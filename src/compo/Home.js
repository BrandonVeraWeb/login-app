    ...
    <nav className='text-center w-full max-xs mt-20 ml-20 mr-20 text-black flex' > 
      <div className=' text-center w-full max-xs mt-20 ml-20 mr-20 text-black'>
        <div className=' bg-slate-100 rounded shadow-md px-8 pt-6 pb-8 mb-4 mr-0' >
          ...
          <button className='text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 ml-2 mt-2' onClick={clicked} >
