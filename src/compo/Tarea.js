...
export default function Tarea({ arrayTareas ,objetoTarea, eliminarTarea, editarTarea, editando }) {
    const stylesPastillaEstado = {
        "pendiente": "text-white bg-gray-800 hover:bg-gray-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900",
        ...
        "terminado": "text-white bg-green-600 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
    }
